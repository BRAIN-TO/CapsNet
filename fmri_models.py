...
class CapsEncoder(keras.Model):
    ...
    '''
    def __init__(self, num_voxels, output_activation='linear'):
        ...
        self.dense = caps_layers.DenseCaps(num_capsules=2, capsule_dim=16, routing='dynamic', activation='norm', name='class_capsules')
...
class ExperimentalEncoder(keras.Model):
    def __init__(self, num_voxels):
        ...
        # Define layers
        self.conv = layers.Conv2D(filters=256, kernel_size=9, strides=(2, 2), padding='valid', activation='relu')
...
class EncoderMach7(ExperimentalEncoder):
    def __init__(self, num_voxels):
        ...
        self.primary = caps_layers.PrimaryCaps2D(num_channels=16, kernel_size=9, capsule_dim=[4, 4], strides=2, padding='valid', activation='sigmoid')
        self.convcaps = caps_layers.ConvCaps2D(16, kernel_size=3, strides=2, capsule_dim=[4,4], routing='EM', routing_iterations=3)
        self.dense1 = caps_layers.DenseCaps(num_capsules=16, capsule_dim=[4, 4], routing='EM', routing_iterations=3)
